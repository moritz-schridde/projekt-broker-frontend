    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: MainTopNavigationBar.appBar(
            context: context, title: "Registrieren bei Trade Empire"),
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    ElevatedButton(
                      ...
                      child: Text(registerProvider.index == 2
                          ? "Abschicken"
                          : "Weiter"),
                    ),
                  ],
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: CountryCodePicker(
                            onChanged: (value) =>
                                registerProvider.updateUserInfo((p0) =>
                                    p0.copyWith.country(value.name ?? "")),
                            initialSelection: 'DE',
                            favorite: ['+49', 'DE'],
